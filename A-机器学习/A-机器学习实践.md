...
- 问题描述：向空中投掷硬币，落地后有两种可能的状态，一个是正面朝上，另一个是反面朝上，每个状态出现的概率为1/2。如投掷均匀的正六面体的骰子，则可能会出现的状态有6个，每一个状态出现的概率均为1/6。试通过计算来比较骰子状态的不确定性与硬币状态的不确定性的大小。
...
> [机器学习中的数据清洗与特征处理综述]([https://tech.meituan.com/machinelearning-data-feature-process.html](https://tech.meituan.com/2015/02/10/machinelearning-data-feature-process.html)) - 美团点评技术
